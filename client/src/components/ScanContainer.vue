    ...
    <section>
        ...
        <form>
            <div class="mb-3 px-2">
                ...
                <input ref="barcode" type="text" class="shadow appearance-none border rounded w-full py-1 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" v-model="barcode" v-on:keydown.enter="onBarcodeEnter" placeholder="Scan the long barcode for the container">        
            </div>

            <div class="mb-3 px-2">
                <label class="block text-gray-700">Location</label>
                <input ref="location" type="text" class="shadow appearance-none border rounded w-full py-1 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" v-model="location" v-on:keydown.enter="onLocationEnter" placeholder="Scan the location e.g. TRAY-A1">
            </div>
