<template>
    <section>
        <h2 class="text-3xl text-center font-bold py-2">Find a Container</h2>
        <form>
          <div class="mb-3 px-2">
...
export default {
    ...
    methods: {
        ...
        onFindContainer: function(event) {
            ...
            if (this.barcode !== "") {
                ...
                this.$http.get(url, {params: {'barcode':barcode}})
                ...
                .catch(function() {
                    ...
                    self.searchResultError = "Container " + barcode + " not found"
                })
                .finally(function() {
