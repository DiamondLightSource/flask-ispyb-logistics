    ...
    <div v-if="isActive" 
      ...
      <div class="w-1/2 bg-white shadow-lg rounded-lg p-4">
        ...
        <section class="p-4">
          ...
          <form>
              <ul class="flex flex-col">
                <li class="flex"><label class="w-1/3 px-2">Visit</label><span v-html="visit" class="w-2/3 leading-tight pb-2">{{ visit }}</span></li>
                <li class="flex"><label class="w-1/3 px-2">Beamline</label><span v-html="beamline" class="w-2/3 leading-tight pb-2">{{ beamline }}</span></li>
                <li class="flex"><label class="w-1/3 px-2">Start Date</label><span v-html="startDate" class="w-2/3 leading-tight pb-2">{{ startDate }}</span></li>
